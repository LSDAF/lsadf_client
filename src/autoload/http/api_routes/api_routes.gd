...
#const KEYCLOAK_PORT: String = "8081"
#const KEYCLOAK_SERVER: String = "http://localhost:" + KEYCLOAK_PORT
...
const FETCH_GAME_SAVES_INVENTORY := APP_URL + "/api/v1/inventory/{game_save_id}"
